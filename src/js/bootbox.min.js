...
!(function(e, t) {
  'use strict';
  typeof define === 'function' && define.amd ? define(['jquery'], t) : typeof exports === 'object' ? (module.exports = t(require('jquery'))) : (e.bootbox = t(e.jQuery));
})(this, function t(p, u) {
  'use strict';
  var r, n, i, l;
  Object.keys ||
    ...
    function(e) {
      if (typeof e !== 'function' && (typeof e !== 'object' || e === null)) throw new TypeError('Object.keys called on non-object');
      var t;
      var o;
      var a = [];
  ...
  function c(e, t, o) {
    return p.extend(
      ...
      (function(e, t) {
        ...
        return o === 2 || typeof e[0] === 'string' ? ((a[t[0]] = e[0]), (a[t[1]] = e[1])) : (a = e[0]), a;
      })(t, o)
    );
  }
  function h(e, t, o, a) {
  ...
  return (
    ...
    (d.removeLocale = function(e) {
      if (e === 'en') throw new Error('"en" is used as the default and fallback locale and cannot be removed.');
      return delete b[e], d;
    }),
    ...
    (d.setDefaults = function() {
      var e = {};
      return arguments.length === 2 ? (e[arguments[0]] = arguments[1]) : (e = arguments[0]), p.extend(m, e), d;
    }),
    (d.hideAll = function() {
    ...
    (d.dialog = function(e) {
      ...
      if (
        ((e = (function(r) {
          var n, i;
          if (typeof r !== 'object') throw new Error('Please supply an object of options');
          ...
          return (
            ...
            (i = w(n)),
            v(n, function(e, t, o) {
              if ((p.isFunction(t) && (t = n[e] = { callback: t }), p.type(t) !== 'object')) throw new Error('button with key "' + e + '" must be an object');
              if ((t.label || (t.label = e), !t.className)) {
                var a = !1;
                (a = r.swapButtonOrder ? o === 0 : o === i - 1), (t.className = i <= 2 && a ? 'btn-primary' : 'btn-secondary btn-default');
              }
            }),
            r
          );
      ...
      var o = p(f.dialog);
      var a = o.find('.modal-dialog');
      var r = o.find('.modal-body');
      var n = p(f.header);
      var i = p(f.footer);
      var l = e.buttons;
      var s = { onEscape: e.onEscape };
      if (
      ...
      if (
        ...
        e.title ? (e.bootstrap > 3 ? o.find('.modal-header').append(c) : o.find('.modal-header').prepend(c)) : c.prependTo(r);
      }
      return (
        e.centerVertical &&
        ...
        o.one('hide.bs.modal', function(e) {
          e.target === this && (o.off('close.bb'), o.off('click'));
        }),
        ...
        e.backdrop !== 'static' &&
          o.on('click.dismiss.bs.modal', function(e) {
            o.children('.modal-backdrop').length && (e.currentTarget = o.children('.modal-backdrop').get(0)), e.target === e.currentTarget && o.trigger('close.bb');
          }),
        o.on('close.bb', function(e) {
    ...
    (d.alert = function() {
      var e;
      if ((e = h('alert', ['ok'], ['message', 'callback'], arguments)).callback && !p.isFunction(e.callback))
        ...
        (r.buttons.confirm.callback = function() {
          ...
          if (r.inputType === 'checkbox')
            e = n
              ...
              .get();
          else if (r.inputType === 'radio') e = n.find('input:checked').val();
          else {
            if (n[0].checkValidity && !n[0].checkValidity()) return !1;
            e =
              r.inputType === 'select' && !0 === r.multiple
                ? n
      ...
      switch (((n = p(f.inputs[r.inputType])), r.inputType)) {
        ...
        case 'password':
          n.val(r.value),
            ...
            r.rows && !isNaN(parseInt(r.rows)) && r.inputType === 'textarea' && n.attr({ rows: r.rows });
          break;
        case 'date':
        case 'time':
        case 'number':
        case 'range':
          if (
            ...
            r.pattern && n.attr('pattern', r.pattern),
            r.required && n.prop({ required: !0 }),
            r.inputType !== 'date' && r.step)
          ) {
            if (!(r.step === 'any' || (!isNaN(r.step) && parseInt(r.step) > 0)))
              throw new Error(
        ...
        case 'radio':
          ...
          v(a, function(e, t) {
            ...
            o.find('input').attr('value', t.value),
              o.find('label').append('\n' + t.text),
              r.value !== u && t.value === r.value && (o.find('input').prop('checked', !0), (s = !1)),
              n.append(o);
          }),
            s &&
              n
