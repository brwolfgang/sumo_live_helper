...
!(function(t, e) {
  ...
  var a = '.' + r;
  var c = g.fn[o];
  var h = { CLOSE: 'close' + a, CLOSED: 'closed' + a, CLICK_DATA_API: 'click' + a + '.data-api' };
  var f = 'alert';
  var d = 'fade';
  var m = 'show';
  var p = (function() {
  ...
  var N = '.active';
  var O = '.btn';
  var k = { CLICK_DATA_API: 'click' + E + C, FOCUS_BLUR_DATA_API: 'focus' + E + C + ' blur' + E + C };
  var P = (function() {
    function n(t) {
      this._element = t;
    }
  ...
  var R = '.data-api';
  var x = g.fn[L];
  var F = { interval: 5e3, keyboard: !0, slide: !1, pause: 'hover', wrap: !0, touch: !0 };
  var U = { interval: '(number|boolean)', keyboard: 'boolean', slide: '(boolean|string)', pause: '(string|boolean)', wrap: 'boolean', touch: 'boolean' };
  var W = 'next';
  var q = 'prev';
  var M = 'left';
  var K = 'right';
  ...
  var lt = (function() {
    ...
    return (
      ...
      (t._triggerSlideEvent = function(t, e) {
        ...
        var o = g.Event(Q.SLIDE, { relatedTarget: t, direction: e, from: i, to: n });
  ...
  var _t = { SHOW: 'show' + ut, SHOWN: 'shown' + ut, HIDE: 'hide' + ut, HIDDEN: 'hidden' + ut, CLICK_DATA_API: 'click' + ut + '.data-api' };
  var mt = 'show';
  var pt = 'collapse';
  var vt = 'collapsing';
  var yt = 'collapsed';
    ...
    return (
      ...
      (t._getParent = function() {
        ...
        _.isElement(this._config.parent)
          ? ((t = this._config.parent), typeof this._config.parent.jquery !== 'undefined' && (t = this._config.parent[0]))
  ...
  var zt = 'right-start';
  var Xt = 'left-start';
  var $t = { offset: 0, flip: !0, boundary: 'scrollParent', reference: 'toggle', display: 'dynamic' };
  var Gt = { offset: '(number|string|function)', flip: 'boolean', boundary: '(string|element)', reference: '(string|element)', display: 'string' };
  var Jt = (function() {
    function c(t, e) {
      (this._element = t),
        (this._popper = null),
    ...
    return (
            ...
            if ((g(t).trigger(i), !i.isDefaultPrevented())) {
              if (!this._inNavbar) {
                ...
                this._config.reference === 'parent'
                  ? (o = t)
                  : _.isElement(this._config.reference) && ((o = this._config.reference), typeof this._config.reference.jquery !== 'undefined' && (o = this._config.reference[0])),
      ...
      (t._getPlacement = function() {
        ...
        var e = Vt;
        return (
          t.hasClass(jt) ? ((e = Qt), g(this._menu).hasClass(xt) && (e = Bt)) : t.hasClass(Ht) ? (e = zt) : t.hasClass(Rt) ? (e = Xt) : g(this._menu).hasClass(xt) && (e = Yt), e
        );
      }),
      ...
      (t._getPopperConfig = function() {
        ...
        return this._config.display === 'static' && (t.modifiers.applyStyle = { enabled: !1 }), t;
      }),
        ...
        if (!t || (t.which !== 3 && (t.type !== 'keyup' || t.which === 9)))
          for (var e = [].slice.call(document.querySelectorAll(Ut)), n = 0, i = e.length; n < i; n++) {
            ...
            if ((t && t.type === 'click' && (s.clickEvent = t), r)) {
              ...
              if (
                g(o).hasClass(Lt) &&
                !(t && ((t.type === 'click' && /input|textarea/i.test(t.target.tagName)) || (t.type === 'keyup' && t.which === 9)) && g.contains(o, t.target))
              ) {
      ...
      (c._dataApiKeydownHandler = function(t) {
        if (
          (/input|textarea/i.test(t.target.tagName)
            ? !(t.which === 32 || (t.which !== 27 && ((t.which !== 40 && t.which !== 38) || g(t.target).closest(qt).length)))
            : Ot.test(t.which)) &&
  ...
  var oe = { backdrop: '(boolean|string)', keyboard: 'boolean', focus: 'boolean', show: 'boolean' };
  var re = {
    HIDE: 'hide' + ee,
    HIDDEN: 'hidden' + ee,
    SHOW: 'show' + ee,
  ...
  var Pe = { AUTO: 'auto', TOP: 'top', RIGHT: 'right', BOTTOM: 'bottom', LEFT: 'left' };
  var Le = {
    animation: !0,
    ...
    return (
      ...
      (t._getConfig = function(t) {
        ...
        return (
          ...
          typeof (t = l({}, this.constructor.Default, e, typeof t === 'object' && t ? t : {})).delay === 'number' && (t.delay = { show: t.delay, hide: t.delay }),
  ...
  var dn = { ACTIVATE: 'activate' + cn, SCROLL: 'scroll' + cn, LOAD_DATA_API: 'load' + cn + '.data-api' };
  ...
  var An = '.' + wn;
  var Nn = g.fn.tab;
  var On = { HIDE: 'hide' + An, HIDDEN: 'hidden' + An, SHOW: 'show' + An, SHOWN: 'shown' + An, CLICK_DATA_API: 'click' + An + '.data-api' };
  ...
  var Vn = '.' + Bn;
  var Yn = g.fn[Qn];
  var zn = { CLICK_DISMISS: 'click.dismiss' + Vn, HIDE: 'hide' + Vn, HIDDEN: 'hidden' + Vn, SHOW: 'show' + Vn, SHOWN: 'shown' + Vn };
  var Xn = 'fade';
  var $n = 'hide';
  var Gn = 'show';
  var Jn = 'showing';
